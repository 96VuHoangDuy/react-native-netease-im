...
import { IParamsLoginChatroom, NIMChatroomInfo, NIMChatroomMember } from 'react-native-netease-im/src/Chatroom/chatroom.type';
...
class NimChatroom {
    ...
    fetchChatroomMember(roomId: string, userId: string): Promise<NIMChatroomMember> {
